...
router.patch('/cart/:userid/:productid', modifyCart)
router.delete('/cart/:productid',deleteCart)

// /products/purchased/:userid -> userid 부분 다 미들웨어로 교체해야한다.
router.get('/purchased/:userid',getPurchased)
router.post('/purchased/:userid/:productid',createPurchased)
router.delete('/purchased/:userid/:productid',deletePurchased)
